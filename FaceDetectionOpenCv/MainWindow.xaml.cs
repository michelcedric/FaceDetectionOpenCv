...
namespace FaceDetectionOpenCv
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            InitializeComponent();
            DetectionService d = new DetectionService();
            d.NewImage += D_NewImage;
        }

        private void D_NewImage(object sender, Bitmap e)
        {
            CameraCapture = e;
        }
        ...
        //        {
        //            var rectangle = new Rectangle(faceDetection.X - 25, faceDetection.Y - 25, faceDetection.Width + 50, faceDetection.Height + 0);
